...
// In-app notifications (PLAN.md §15.5 J1, §15.8 P1).
//
// The row is the notification; delivery is a separate concern. P2 adds web
// push on top of `createNotification` — a push is a second copy of something
// already durable here, which is what makes "the push failed" a cosmetic
// problem rather than a lost message.
